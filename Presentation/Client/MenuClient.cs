...
namespace Presentation.Client
{
    public partial class MenuClient : Form
    {
        ...
        {
            lblnombrec.Text = UserLoginCache.firstName + " " + UserLoginCache.lastName;
            lblrolc.Text = UserLoginCache.position;
            lblemailc.Text = UserLoginCache.email;
        }
        ...
        private void Btnslideclient_Click(object sender, EventArgs e)
        {
        ...
        //Presenta
        private void btnRestaurarc_Click(object sender, EventArgs e)
        {
            btnMaximizar.Visible = true;
            btnRestaurarc.Visible = false;
            this.Size = new Size(sw, sh);
        ...
        private void btnMinimizarpro_Click_1(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Minimized;
        }
        ...
        {
            AbrirFormulario<Form1test>();
            button5.BackColor = Color.FromArgb(12, 61, 92);
        }

        private void timerclient_Tick(object sender, EventArgs e)
        {
            lblhorac.Text = DateTime.Now.ToLongTimeString();
